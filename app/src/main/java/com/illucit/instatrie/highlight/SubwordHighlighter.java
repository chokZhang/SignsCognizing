...
public interface SubwordHighlighter {
	 ...
	 */
    HighlightedString highlightSubwordPrefixes(String value, Set<String> queryWords);
	 ...
	 * @return highlighted String
	 */
    HighlightedString highlightSubwordPrefixesWithHtml(String value, Set<String> queryWords);
